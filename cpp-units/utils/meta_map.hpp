...
// type-traits for meta_pair and meta_map
...
template <typename Pair, typename... Rest>
struct meta_map<Pair, Rest...>: meta_map<Rest...> {};

template <typename Pair, typename... Rest>
requires is_unique_key_in_pair_list_v<Pair, Rest...>
struct meta_map<Pair, Rest...>: meta_map<Rest...> {
    using pair = Pair;
    using next = meta_map<Rest...>;
    ...
    template <auto Key, auto Value>
    struct set {
        using type = meta_map<Pair, Rest..., meta_pair<Key, Value>>;
    };
